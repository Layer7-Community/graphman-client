...
const SUPPORTED_EXTENSIONS = ["pre-request", "post-export", "pre-import", "post-renew", "multiline-text-diff", "policy-code-validator"];
...
function makeOptions(options) {
    return Object.assign({
        ...
        "keyFormat": "p12",
        "extensions": ["pre-request", "post-export", "pre-import", "post-renew"]
    }, options);
}
