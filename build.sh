...
distDir=build/dist
packageDir=build/layer7-graphman-client
wrapperDir=build/layer7-graphman-client-wrapper
...
tar -czvf build/layer7-graphman-wrapper.tar.gz $wrapperDir

mv $packageDir/layer7-graphman-*.tgz build/dist/.
mv build/layer7-graphman-wrapper.tar.gz build/dist/.
